 ...
 <div class="top-bar d-none d-md-block">
    ...
    <li><a href="{{route('userpanel.addappointment')}}"><i class="fa fa-heart-o"></i> Add Appointments </a></li>
    <li><a href="{{route('userpanel.reviews')}}"><i class="fa fa-exchange"></i> My Reviews </a></li>
    <li><a href="{{route('userpanel.myappointment')}}"><i class="fa fa-check"></i>My Appointments </a></li>
